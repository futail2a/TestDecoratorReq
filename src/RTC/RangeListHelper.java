...
/*!
     * @typedef RangeList
     */
abstract public class RangeListHelper
{
  private static String  _id = "IDL:RTC/RangeList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RTC.RangeListHelper.id (), "RangeList", __typeCode);
    }
    return __typeCode;
  }
