...
/*!
     * @typedef OGMapCells
     */
abstract public class OGMapCellsHelper
{
  private static String  _id = "IDL:RTC/OGMapCells:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RTC.OGMapCellsHelper.id (), "OGMapCells", __typeCode);
    }
    return __typeCode;
  }
