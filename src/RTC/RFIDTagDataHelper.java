...
/*!
     * @typedef RFIDTagData
     */
abstract public class RFIDTagDataHelper
{
  private static String  _id = "IDL:RTC/RFIDTagData:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RTC.RFIDTagDataHelper.id (), "RFIDTagData", __typeCode);
    }
    return __typeCode;
  }
