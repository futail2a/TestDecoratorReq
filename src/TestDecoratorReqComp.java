// -*- Java -*-
/*!
 * @file TestDecoratorReqComp.java
...
/*!
 * @class TestDecoratorReqComp
 * @brief Standalone component Class
 *
 */
public class TestDecoratorReqComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(TestDecoratorReq.component_conf);
      mgr.registerFactory(prop, new TestDecoratorReq(), new TestDecoratorReq());

      // Create a component
      RTObject_impl comp = mgr.createComponent("TestDecoratorReq");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        TestDecoratorReqComp init = new TestDecoratorReqComp();
